...
public class StockDAO {
    ...
    /**
     * The inner StockData class models the stock data record for a particular date.
     * It holds various trading metrics such as price, open, high, low, and volume.
     * This inner class is used by the StockDAO to encapsulate the data parsed from the CSV file.
     */
    public static class StockData {
        // The date for the stock data record (immutable after creation).
        private final LocalDate date;
        // The recorded price of the stock.
        private Double price;
        // The opening price of the stock on the date.
        private Double open;
        // The highest price recorded on the date.
        private Double high;
        // The lowest price recorded on the date.
        private Double low;
        // The closing price on the date.
        private Double close;
        // The trading volume on the date.
        private Long volume;
        // The adjusted closing price (if applicable).
        private Double adjClose;

        /**
         * Constructor to initialize the StockData record with its associated date.
         *
         * @param date the LocalDate for which this record applies.
         */
        ...
        /**
         * Returns the date of this stock record.
         *
        ...
        /**
         * Returns the stock's general price.
         *
        ...
        /**
         * Sets the price for this stock record.
         *
        ...
        /**
         * Returns the lowest price recorded.
         *
         ...
         *
         * @return the adjusted close as a Double.
         */
        ...
        /**
         * Sets the adjusted closing price.
         *
         * @param adjClose the adjusted close value to set.
         */
        ...
        /**
         * Provides a string representation of the StockData object.
         * This is useful for debugging and logging purposes.
         *
         * @return a formatted string containing all data fields.
         */
        @Override
